        ...
        <tbody>
            @foreach ($data as $item)
                <tr class="text-center">
                    ...
                    <td>
                        <a href="{{route('category.edit',$item->id)}}" class="mr-3 btn btn-primary "><i class="fas fa-edit"></i></a>
                        <a href="{{ route('category.destroy', $item->id) }}" class="ml-3 btn btn-danger btndelete"><i
